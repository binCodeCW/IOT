...
namespace YH.Framework.Commons.Web
{
    /// <summary>
    /// 验证码类
    /// </summary>
    ...
    internal class Rand
    {
        ...
        {
            return OnlyNumber(Length, false);
        }
        ...
        public static string OnlyNumber(int Length, bool Sleep)
        {
        ...
        /// </summary>
        /// <param name="Length">生成长度</param>
        public static string CharAndNumber(int Length)
        {
            return CharAndNumber(Length, false);
        }
        ...
        /// <param name="Length">生成长度</param>
        /// <param name="Sleep">是否要在生成前将当前线程阻止以避免重复</param>
        public static string CharAndNumber(int Length, bool Sleep)
        {
            if (Sleep) System.Threading.Thread.Sleep(3);
        ...
        /// </summary>
        /// <param name="Length">生成长度</param>
        public static string OnlyChar(int Length)
        {
            return OnlyChar(Length, false);
        }
        ...
        /// <param name="Length">生成长度</param>
        /// <param name="Sleep">是否要在生成前将当前线程阻止以避免重复</param>
        public static string OnlyChar(int Length, bool Sleep)
        {
            if (Sleep) System.Threading.Thread.Sleep(3);
