...
{
    /// <summary>
    /// Web页面预览效果图片抓取辅助类（可供Asp.Net直接调用的包装类）
    /// </summary>
    public class WebPreview
    {
        ...
        private WebPreview(Uri uri, Size size) : this(uri, 30 * 1000, size.Width, size.Height, true)
        {
        }
        ...
        /// </summary>
        /// <param name="uri">页面地址</param>
        /// <param name="size">页面位置（宽高）</param>
        /// <returns></returns>
        public static Bitmap GetWebPreview(Uri uri, Size size)
        {
            WebPreview wp = new WebPreview(uri, size);
            return wp.GetWebPreview();
        }
        ...
        /// </summary>
        /// <param name="uri">页面地址</param>
        /// <param name="timeout">截图超时时间</param>
        /// <param name="width">图形宽度</param>
        /// <param name="height">图形高度</param>
        /// <param name="fullPage">全页面</param>
        /// <returns></returns>
