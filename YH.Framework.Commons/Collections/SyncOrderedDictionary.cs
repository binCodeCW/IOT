...
namespace YH.Framework.Commons.Collections
{
    ...
    public class SyncOrderedDictionary<TKey, TValue> : OrderedDictionary<TKey, TValue>
    {
        ...
        private OrderedDictionary<TKey, TValue> dictionarytable = new OrderedDictionary<TKey,TValue>();
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("ParentTable", this.dictionarytable, typeof(CDictionary<TKey, TValue>));
        }
