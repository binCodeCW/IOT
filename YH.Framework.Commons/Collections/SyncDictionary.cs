...
namespace YH.Framework.Commons.Collections
{
    /// <summary>
    ...
    public class SyncDictionary<TKey, TValue> : CDictionary<TKey, TValue>
    {
        ...
        private CDictionary<TKey, TValue> dictionary = new CDictionary<TKey,TValue>();
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("ParentTable", this.dictionary, typeof(CDictionary<TKey, TValue>));
        }
        ...
        internal SyncDictionary(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            this.dictionary = (CDictionary<TKey, TValue>)info.GetValue("ParentTable", typeof(CDictionary<TKey, TValue>));
