...
namespace YH.Framework.Commons
{
    ...
    public class SysTray : IDisposable
    {
        ...
        /// Sets the animation clip that will be displayed in the system tray
        /// </summary>
        /// <param name="bitmap">The array of bitmaps which forms each frame of the animation
        ...
        /// Sets the animation clip that will be displayed in the system tray
        /// </summary>
        /// <param name="bitmapStrip">The bitmap strip that contains the frames of animation.
        ...
        /// </summary>
        /// <param name="loopCount">whether to loop infinitely or stop after one iteration</param>
