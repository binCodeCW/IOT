...
namespace YH.Framework.Commons
{
	...
	/// <summary>
    /// 内置拖拉的TreeView控件，可定义ICON/Cursor
	/// </summary>
	...
	public class TreeViewDragDrop : System.Windows.Forms.TreeView
	{
		...
		protected override void OnItemDrag(System.Windows.Forms.ItemDragEventArgs e)
		{
			...
			int width = (int)(this._selectedNode.Text.Length * (int) this._formDrag.labelText.Font.Size * 1.5f);
			...
			if( e.Data.GetDataPresent("System.Windows.Forms.TreeNode", false) )
			{
                ...
                if (targetNode != null)
                {
                    ...
                    if (targetNode != dragNode && !
                        targetNode.FullPath.StartsWith(dragNode.FullPath) && 
		...
		internal class FormDrag : System.Windows.Forms.Form
		{
			...
			private void InitializeComponent()
			{
				...
				this.labelText.Size = new System.Drawing.Size(100, 22);
