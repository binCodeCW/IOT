...
namespace YH.Framework.Commons
{
    ...
    public class SmtpServerHelper
    {
        ...
        /// <param name="ESmtp">ESMTP协议发送</param>
    ...
    //mail.Attachments=ma;
    //mail.Body="你好";
    //mail.AddRecipients("wuhuacong@163.com");
    //mail.From="wuhuacong@163.com";
    //mail.FromName="wuhuacong";
    //mail.Subject="Hello";
    //SmtpClient sp = new SmtpClient();
    //sp.SmtpServer = "smtp.163.com";
    //sp.Send(mail, "wuhuacong@163.com", "123456");
    //------------------------------------------------
    public class SmtpClient
    {
        ...
        /// 参数构造函数
        /// </summary>
        /// <param name="_smtpServer">smtp服务器</param>
