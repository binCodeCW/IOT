...
namespace YH.Framework.Commons
{
    ...
    public class Serializer
    {
        ...
        /// 序列化到流
        /// </summary>
        /// <param name="o">需要序列化的对象实例</param>
        /// <returns>序列化后的对象流</returns>
        ...
        /// 从流反序列化
        /// </summary>
        /// <param name="stream">包含序列化信息的二进制流</param>
        /// <returns>反序例化成功后的对象引用</returns>
        ...
        /// </summary>
        /// <param name="type">对象的类型</param>
        /// <param name="path">二进制字节数组存储的文件</param>
        /// <returns></returns>
