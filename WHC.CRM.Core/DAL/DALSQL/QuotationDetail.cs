...
namespace WHC.CRM.DALSQL
{
    ...
    /// 报价单明细
    /// </summary>
	public class QuotationDetail : BaseDALSQL<QuotationDetailInfo>, IQuotationDetail
	{
		#region 对象实例及构造函数

		public static QuotationDetail Instance
		{
			get
			{
		...
		public QuotationDetail() : base("T_CRM_QuotationDetail","ID")
        {
		...
		protected override QuotationDetailInfo DataReaderToEntity(IDataReader dataReader)
		{
			QuotationDetailInfo info = new QuotationDetailInfo();
        ...
        protected override Hashtable GetHashByEntity(QuotationDetailInfo obj)
		{
		    QuotationDetailInfo info = obj as QuotationDetailInfo;
