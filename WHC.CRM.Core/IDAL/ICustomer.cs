...
namespace WHC.CRM.IDAL
{
    ...
    public interface ICustomer : IBaseDAL<CustomerInfo>
    {
        ...
        /// <returns></returns>
        bool ChangeOwner(string id, string userId, string companyId);     
        ...
        /// <returns></returns>
        List<CustomerInfo> FindByGroupName(string ownerUser, string groupName, string condition, PagerInfo pagerInfo = null);
