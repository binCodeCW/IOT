...
namespace YH.Framework.ControlUtil.Facade
{
    /// <summary>
    ...
    public class BaseWCFService<T> : IBaseService<T> where T : BaseEntity, new()
    {
        ...
        public virtual bool InsertRange(List<T> list)
        {
            ...
            comm.Using(client =>
            {
                result = service.InsertRange(list);
            });
            return result;
        }
        ...
        public virtual List<T> FindWithPager(string condition, ref PagerInfo info)
        {
            ...
            IBaseService<T> service = CreateClient();
            ICommunicationObject comm = service as ICommunicationObject;
            YH.Pager.Entity.PagerInfo pagerInfo = info;
            comm.Using(client =>
            {
        ...
        public virtual string GetFieldValue(string key, string fieldName)
        {
            ...
            comm.Using(client =>
            {
                result = service.GetFieldValue(key, fieldName);
            });
        ...
        public virtual Dictionary<string, string> GetFieldValueList(string key, List<string> fieldNameList)
        {
            ...
            comm.Using(client =>
            {
                result = service.GetFieldValueList(key, fieldNameList);
            });
        ...
        public virtual string GetDisplayColumns()
        {
            ...
            comm.Using(client =>
            {
                result = service.GetDisplayColumns();
            });
