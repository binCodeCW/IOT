...
namespace WHC.WorkflowLite.DALSQL
{
    ...
    /// 请假申请单
    /// </summary>
	public class Leave : BaseDALSQL<LeaveInfo>, ILeave
	{
		#region 对象实例及构造函数
        ...
        protected override LeaveInfo DataReaderToEntity(IDataReader dataReader)
		{
			...
			info.Duration = reader.GetDouble("Duration");
        ...
        protected override Hashtable GetHashByEntity(LeaveInfo obj)
		{
		    LeaveInfo info = obj as LeaveInfo;
        ...
        public override Dictionary<string, string> GetColumnNameAlias()
        {
            ...
            //dict.Add("ID", "编号");
            dict.Add("ID", "");
             dict.Add("Category", "请假类型");
             dict.Add("StartTime", "开始时间");
             dict.Add("EndTime", "结束时间");
             dict.Add("Duration", "请假时长");
             dict.Add("Reason", "请假事由");
        ...
        {
            return "ID,Category,StartTime,EndTime,Duration,Reason,AttachGUID,Apply_ID,ApplyDate,ApplyDept,Note,Creator,CreateTime,Editor,EditTime";
        }
    }
}