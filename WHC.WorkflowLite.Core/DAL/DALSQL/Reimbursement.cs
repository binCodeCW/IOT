...
namespace WHC.WorkflowLite.DALSQL
{
    ...
    /// 报销申请单
    /// </summary>
	public class Reimbursement : BaseDALSQL<ReimbursementInfo>, IReimbursement
	{
		#region 对象实例及构造函数

		public static Reimbursement Instance
		{
			get
			{
		...
		public Reimbursement() : base("TW_Reimbursement", "ID")
        {
        ...
        protected override ReimbursementInfo DataReaderToEntity(IDataReader dataReader)
		{
        ...
        protected override Hashtable GetHashByEntity(ReimbursementInfo obj)
		{
		    ReimbursementInfo info = obj as ReimbursementInfo;
        ...
        public override Dictionary<string, string> GetColumnNameAlias()
        {
            ...
            //dict.Add("ID", "编号");
            dict.Add("ID", "");
             dict.Add("Category", "报销类型");
             dict.Add("Reason", "报销事由");
             dict.Add("TotalAmount", "总金额");
        ...
        {
            return "ID,Category,Reason,TotalAmount,Apply_ID,ApplyDate,ApplyDept,Note,Creator,CreateTime,Editor,EditTime";
        }
    }
}