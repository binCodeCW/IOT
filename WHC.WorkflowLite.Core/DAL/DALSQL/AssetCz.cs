...
namespace WHC.WorkflowLite.DALSQL
{
    ...
    /// 资产处置单
    /// </summary>
	public class AssetCz : BaseDALSQL<AssetCzInfo>, IAssetCz
	{
		#region 对象实例及构造函数

		public static AssetCz Instance
		{
			get
			{
				return new AssetCz();
		...
		public AssetCz() : base("T_AssetCz","ID")
        {
		...
		protected override AssetCzInfo DataReaderToEntity(IDataReader dataReader)
		{
        ...
        protected override Hashtable GetHashByEntity(AssetCzInfo obj)
		{
		    AssetCzInfo info = obj as AssetCzInfo;
        ...
        public override Dictionary<string, string> GetColumnNameAlias()
        {
            ...
            dict.Add("ID", "编号");
             ...
             dict.Add("AssetDesc", "处置资产");
             dict.Add("ChargeDept", "资产管理部门（单位）");
             dict.Add("DeptAdmin", "部门资产管理员");
        ...
        {
            return "ID,BillNo,AssetDesc,ChargeDept,DeptAdmin,Apply_ID,ApplyDate,ApplyDept,Note,AttachGUID,Creator,CreateTime,Editor,EditTime";
        }
    }
}