...
namespace YH.Security.DALSQL
{
    ...
    /// 记录操作日志的数据表配置
    /// </summary>
    public class OperationLogSetting : BaseDALSQL<OperationLogSettingInfo>, IOperationLogSetting
    {
        #region 对象实例及构造函数
        ...
        {
            return "TableName,Forbid,InsertLog,DeleteLog,UpdateLog,Note,Creator,CreateTime,Editor,EditTime";
        }
    }
}