...
namespace YH.Security.BLL
{
    ...
    public class Role : BaseBLL<RoleInfo>
	{
        ...
        {
            return roleDal.EditRoleFunctions(roleID, newFunctionList, systemType);
        }
        ...
        {
            roleDal.RemoveMenu(menuID, roleID);
        }
        ...
        {
            return roleDal.EditRoleMenus(roleID, newList, systemType);
        }
	}
}