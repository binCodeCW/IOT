...
namespace IOT.NA
{
    public class NASDK
    {
        ...
        public string sendCommand(string token, string deviceId, string callbackurl, string expireTime, string serviceId, string commandId, List<CommandPara> lsParas)
        {
            string result = null;
            ...
            //body = "{\"deviceId\":\"72792c1b-bb70-498d-9a73-794649b380c7\",\"command\":{\"serviceId\":\"ConsumablesControl\",\"method\":\"DEVICE_CONTROL\",\"paras\":{\"deviceControl\":1}},\"callbackUrl\":\"\"}";
            //body =  "{\"serviceId\": \"ConsumablesControl\", \"method\": \"DEVICE_CONTROL\", \"paras\": \"{\"deviceControl\":0}\" }";
            try
            {
                ApiResult apiresult = PostUrl(apiPath, body, headers, method, contenttype, this.m_p12certfile, this.m_certpassword);
                log(apiresult.statusCode.ToString() + apiresult.result);
